                        ...
                        <div className="rewards-summary">
                            <div className="summary-card">
                                ...
                                <div className="summary-info">
                                    <h3 className="summary-title">Total Rewards Earned</h3>
                                    <p className="summary-value">1,850 Points</p>
                                </div>
                            </div>
                            <div className="summary-card">
                                <div className="summary-icon">📊</div>
                                <div className="summary-info">
                                    ...
                                    <p className="summary-value">2/6 Completed</p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="rewards-list">
                                {rewards.map((reward) => (
                                    <div key={reward.id} className={`reward-card ${reward.status}`}>
                                        ...
                                        <button className={`reward-claim-btn ${reward.status}`}>
