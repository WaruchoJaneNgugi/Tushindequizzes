...
export const ProfileOverlay: FC<ProfileOverlayProps> = ({ onClose }) => {
    const { user, logout } = useAuth();
    const {setShowBuyPoints,setShowProfile}=useUI()
    const profileStats = [
    ...
    //     { name: 'First Win', date: '2 days ago', icon: '🥇' },
    //     { name: 'Quiz Master', date: '1 week ago', icon: '🧠' },
    //     { name: 'Speedster', date: '2 weeks ago', icon: '⚡' },
    // ];
                ...
                <div className="feature-overlay-content">
                    <div className="profile-container">
                        <div className="profile-header">
                            ...
                            <button className="btn-edit-profile" onClick={()=>setShowProfile(true)}>
                        ...
                        {/*        ))}*/}
                        {/*    </div>*/}
                        {/*    <button className="btn-view-all-achievements">*/}
