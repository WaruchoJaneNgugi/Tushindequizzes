  ...
  return (
      <div className="app-wrapper">
        <div className="app-card">
          ...
          {/* Header */}
          <div className="header app-header-dynamic" style={{ width: canvasWidth ? `${canvasWidth}px` : '100%' }}>
          ...
          <div className="app-message-wrapper" style={{ width: canvasWidth ? `${canvasWidth}px` : '100%' }}>
